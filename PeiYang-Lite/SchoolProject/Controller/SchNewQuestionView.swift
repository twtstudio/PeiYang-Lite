...
struct SchNewQuestionView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack {
                HStack {
                    TextEditor(text: $textManager.title)
                        ...
                        .frame(height: screen.height / 25, alignment: .center)
                        .onTapGesture {
                            if !titleDidChange {
                                textManager.title = ""
                                titleDidChange = true
                ...
                seperator.frame(width: screen.width * 0.85, height: 1, alignment: .center)
            ...
            .padding()
            .frame(width: screen.width * 0.9, height: screen.height * 0.6, alignment: .center)
