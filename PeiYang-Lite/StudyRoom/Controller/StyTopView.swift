...
//    @StateObject private var studyRoomModel: StudyRoomModel = StudyRoomModel()
    ...
    var body: some View {
        ...
        VStack (spacing: 25){
            ...
            .frame(width: screen.width * 0.9, height: screen.height / 20, alignment: .center)
            ...
            if(isGetStudyRoomBuildingMessage == false) {
                ...
                .frame(width: screen.width * 0.9,height: screen.height * 0.4, alignment: .center)
...
//                    .frame(width: screen.width, height: screen.height * 0.35, alignment: .center)
        ...
        .background(Color(#colorLiteral(red: 0.9352087975, green: 0.9502342343, blue: 0.9600060582, alpha: 1)).frame(width: screen.width, height: screen.height, alignment: .center).ignoresSafeArea())
        .addAnalytics(className: "StudyRoomMainView")
