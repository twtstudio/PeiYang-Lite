    ...
    //MARK: the second section
                ...
                VStack(spacing: 0){
                    Toggle(isOn: $isRemindBeforeClass) {
                        ...
                        .cornerRadius(screen.height / 60, corners: .topLeft)
                        .cornerRadius(screen.height / 60, corners: .topRight)
                        .cornerRadius(isRemindBeforeClass ? 0 : screen.height / 60, corners: .bottomLeft)
                        .animation(.easeInOut)
                        .cornerRadius(isRemindBeforeClass ? 0 : screen.height / 60, corners: .bottomRight)
                        .animation(.easeInOut)
                    ...
                    HStack{
                        ...
                        .background(Color.white)
                        .cornerRadius(screen.height / 60, corners: .bottomLeft)
                        .cornerRadius(screen.height / 60, corners: .bottomRight)
