...
struct ScrollViewWithRefresh<Content: View>: View {
    ...
    init(_ thresholdHeight: CGFloat = 120, refreshing: Binding<Bool>, onScroll: @escaping (CGRect, CGPoint) -> Void = {_,_  in }, loadAction: @escaping () -> Void, @ViewBuilder content: () -> Content) {
        self.thresholdHeight = thresholdHeight
        self._refreshing = refreshing
        self.onScroll = onScroll
        self.content = content()
        self.loadData = loadAction
    }
